 ...
 * $0 (file reads only). Swap these for your own, or add to them — cadence loops over whatever it's given.
 *
 * `leverage` is a coarse priority tag (see LEVERAGE weights in cadence.cjs); higher ranks first.
 */
